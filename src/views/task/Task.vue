      ...
      <el-form-item label="科目" v-for="(item,index) in tableSubjectDate" class="subjectlabel">
            <el-col :span="6">
                <el-form-item prop="subject">
                    <el-input type="text" v-model="formModel.subject" :placeholder="item.subjectname" disabled=""/>
                </el-form-item>
            </el-col>
        <el-col class="text-center" :span="1" >-</el-col>
            <el-col :span="6" style="text-align: center;">
                <el-form-item label="头像" prop="files">
                    <el-upload :action="RequestUploads" list-type="picture-card" multiple="false" name="file" :limit=1 
            ...
            <el-col :span="6">
                <el-form-item prop="content">
                    <el-input type="textarea" v-model="formModel.content" placeholder="详细内容"/>
                </el-form-item>
            </el-col>
      </el-form-item>

      <el-form-item>
        <el-button type="primary" @click="onHandleSubmit" v-loading="loading">提交</el-button>
